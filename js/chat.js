import { MAX_MESSAGES, TRANSLATE_DELAY_MS } from './config.js?v=0.8.19';
import { state } from './state.js?v=0.8.19';
import { escapeHtml, sleep } from './utils.js?v=0.8.19';
import { translateText, getCachedTranslation, shouldSkipTranslation, detectEmoteSpam } from './translate.js?v=0.8.19';
import { isBotOrCommand } from './filter.js?v=0.8.19';
