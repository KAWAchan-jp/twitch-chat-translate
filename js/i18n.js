const T = {
  ja: {
    ...
    customCss: 'カスタムCSS',
    chromaBg: 'クロマキー背景色',
    chromaBgHint: 'OBSでクロマキー除去する色',
    decoBackground: '背景色',
    decoBackgroundHint: 'すべてのプリセットの背景色',
    decoTextColors: '文字色',
    decoResetColors: '選択中プリセットのデフォルト色に戻す',
    decoMessageGap: '囲いの間隔',
    decoExpiry: '時間が経てば消える',
    decoExpiryNone: '消去しない',
    secondsUnit: '秒',
  ...
  en: {
    ...
    decoSettings: 'Appearance',
    presetLabel: 'Preset',
    showElements: 'Show elements',
    elemUsername: 'Name',
    elemTime: 'Time',
    elemOriginal: 'Original',
    elemTranslated: 'Translation',
    effectLabel: 'Effect',
    customCss: 'Custom CSS',
    chromaBg: 'Chroma Key Color',
    chromaBgHint: 'Color to key out in OBS',
    decoBackground: 'Background Color',
    decoBackgroundHint: 'Background color for all presets',
    decoTextColors: 'Text Colors',
    decoResetColors: 'Restore selected preset colors',
    decoMessageGap: 'Message Spacing',
    decoExpiry: 'Disappear After Time',
    decoExpiryNone: 'Do not remove',
    secondsUnit: 'sec',
  ...
  ko: {
    ...
    customCss: '커스텀 CSS',
    chromaBg: '크로마키 배경색',
    chromaBgHint: 'OBS에서 크로마키 제거할 색상',
    decoBackground: '배경색',
    decoBackgroundHint: '모든 프리셋의 배경색',
    decoTextColors: '글자색',
    decoResetColors: '선택한 프리셋의 기본 색상으로 복원',
    decoMessageGap: '메시지 간격',
    decoExpiry: '시간이 지나면 사라짐',
    decoExpiryNone: '삭제하지 않음',
    secondsUnit: '초',
  ...
  'zh-CN': {
    ...
    customCss: '自定义 CSS',
    chromaBg: '色度键背景色',
    chromaBgHint: '在OBS中用色度键去除的颜色',
    decoBackground: '背景色',
    decoBackgroundHint: '所有预设的背景色',
    decoTextColors: '文字颜色',
    decoResetColors: '恢复所选预设的默认颜色',
    decoMessageGap: '消息间距',
    decoExpiry: '定时消失',
    decoExpiryNone: '不删除',
    secondsUnit: '秒',
  ...
  'zh-TW': {
    ...
    customCss: '自訂 CSS',
    chromaBg: '色度鍵背景色',
    chromaBgHint: '在OBS中用色度鍵去除的顏色',
    decoBackground: '背景色',
    decoBackgroundHint: '所有預設的背景色',
    decoTextColors: '文字顏色',
    decoResetColors: '還原所選預設的預設顏色',
    decoMessageGap: '訊息間距',
    decoExpiry: '定時消失',
    decoExpiryNone: '不移除',
    secondsUnit: '秒',
  ...
  es: {
    ...
    decoSettings: 'Apariencia',
    presetLabel: 'Preajuste',
    showElements: 'Mostrar elementos',
    elemUsername: 'Nombre',
    elemTime: 'Hora',
    elemOriginal: 'Original',
    elemTranslated: 'Traducción',
    effectLabel: 'Efecto',
    customCss: 'CSS personalizado',
    chromaBg: 'Color de Chroma Key',
    chromaBgHint: 'Color para eliminar en OBS',
    decoBackground: 'Color de fondo',
    decoBackgroundHint: 'Color de fondo para todos los preajustes',
    decoTextColors: 'Colores de texto',
    decoResetColors: 'Restaurar colores del preajuste seleccionado',
    decoMessageGap: 'Espacio entre mensajes',
    decoExpiry: 'Desaparecer después de un tiempo',
    decoExpiryNone: 'No eliminar',
    secondsUnit: 's',
  ...
  fr: {
    ...
    decoSettings: 'Apparence',
    presetLabel: 'Préréglage',
    showElements: 'Éléments affichés',
    elemUsername: 'Nom',
    elemTime: 'Heure',
    elemOriginal: 'Original',
    elemTranslated: 'Traduction',
    effectLabel: 'Effet',
    customCss: 'CSS personnalisé',
    chromaBg: 'Couleur Chroma Key',
    chromaBgHint: 'Couleur à supprimer dans OBS',
    decoBackground: 'Couleur de fond',
    decoBackgroundHint: 'Couleur de fond pour tous les préréglages',
    decoTextColors: 'Couleurs du texte',
    decoResetColors: 'Restaurer les couleurs du préréglage sélectionné',
    decoMessageGap: 'Espacement des messages',
    decoExpiry: 'Disparaître après un délai',
    decoExpiryNone: 'Ne pas supprimer',
    secondsUnit: 's',
  ...
  de: {
    ...
    decoSettings: 'Darstellung',
    presetLabel: 'Vorlage',
    showElements: 'Elemente anzeigen',
    elemUsername: 'Name',
    elemTime: 'Zeit',
    elemOriginal: 'Original',
    elemTranslated: 'Übersetzung',
    effectLabel: 'Effekt',
    customCss: 'Eigenes CSS',
    chromaBg: 'Chroma-Key-Farbe',
    chromaBgHint: 'Farbe für OBS Chroma-Key',
    decoBackground: 'Hintergrundfarbe',
    decoBackgroundHint: 'Hintergrundfarbe für alle Vorlagen',
    decoTextColors: 'Textfarben',
    decoResetColors: 'Farben der ausgewählten Vorlage wiederherstellen',
    decoMessageGap: 'Nachrichtenabstand',
    decoExpiry: 'Nach Zeit ausblenden',
    decoExpiryNone: 'Nicht entfernen',
    secondsUnit: 'Sek.',
  ...
  pt: {
    ...
    decoSettings: 'Aparência',
    presetLabel: 'Predefinição',
    showElements: 'Mostrar elementos',
    elemUsername: 'Nome',
    elemTime: 'Hora',
    elemOriginal: 'Original',
    elemTranslated: 'Tradução',
    effectLabel: 'Efeito',
    customCss: 'CSS personalizado',
    chromaBg: 'Cor do Chroma Key',
    chromaBgHint: 'Cor para remover no OBS',
    decoBackground: 'Cor de fundo',
    decoBackgroundHint: 'Cor de fundo para todas as predefinições',
    decoTextColors: 'Cores do texto',
    decoResetColors: 'Restaurar cores da predefinição selecionada',
    decoMessageGap: 'Espaçamento das mensagens',
    decoExpiry: 'Desaparecer após um tempo',
    decoExpiryNone: 'Não remover',
    secondsUnit: 's',
    connecting:     (ch)       => `Conectando a #${ch}...`,
  ...
  ru: {
    ...
    decoSettings: 'Оформление',
    presetLabel: 'Пресет',
    showElements: 'Показывать',
    elemUsername: 'Имя',
    elemTime: 'Время',
    elemOriginal: 'Оригинал',
    elemTranslated: 'Перевод',
    effectLabel: 'Эффект',
    customCss: 'Свой CSS',
    chromaBg: 'Цвет хромакея',
    chromaBgHint: 'Цвет для удаления хромакеем в OBS',
    decoBackground: 'Цвет фона',
    decoBackgroundHint: 'Цвет фона для всех пресетов',
    decoTextColors: 'Цвета текста',
    decoResetColors: 'Восстановить цвета выбранного пресета',
    decoMessageGap: 'Интервал между сообщениями',
    decoExpiry: 'Исчезновение по времени',
    decoExpiryNone: 'Не удалять',
    secondsUnit: 'с',
  ...
  id: {
    ...
    decoSettings: 'Tampilan',
    presetLabel: 'Preset',
    showElements: 'Tampilkan elemen',
    elemUsername: 'Nama',
    elemTime: 'Waktu',
    elemOriginal: 'Asli',
    elemTranslated: 'Terjemahan',
    effectLabel: 'Efek',
    customCss: 'CSS kustom',
    chromaBg: 'Warna Chroma Key',
    chromaBgHint: 'Warna untuk dihapus di OBS',
    decoBackground: 'Warna latar',
    decoBackgroundHint: 'Warna latar untuk semua preset',
    decoTextColors: 'Warna teks',
    decoResetColors: 'Pulihkan warna preset yang dipilih',
    decoMessageGap: 'Jarak pesan',
    decoExpiry: 'Hilang setelah beberapa waktu',
    decoExpiryNone: 'Jangan hapus',
    secondsUnit: 'dtk',
